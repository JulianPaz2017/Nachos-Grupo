...
#include "machine.hh" // Agregado para GetNumPhysicalPages()
#include "system.hh"  // Agregado para tener machine como variable global
...
Memory:\n\
 ...
 Memory size: %u bytes.\n", PAGE_SIZE,NUM_PHYS_PAGES,TLB_SIZE, NUM_PHYS_PAGES * PAGE_SIZE);
   printf("\n\
Disk:\n\
 Sector size: %u bytes.\n\
 Sectors per track: %u.\n\
